...
public class Help implements Serializable {
    ...
    public Help(Integer id, Integer helpOwnerId, String helpTitle, String helpDetail, Integer helpPaid, Integer helpLike, Integer helpCollect, Integer helpComment, String helpLabel) {
        this.id = id;
        this.helpOwnerId = helpOwnerId;
        this.helpTitle = helpTitle;
        this.helpDetail = helpDetail;
    ...
    public Help(String helpTitle, String helpDetail, Integer helpPaid, Integer helpLike, Integer helpCollect, Integer helpComment, String helpLabel) {
        this.helpTitle = helpTitle;
        this.helpDetail = helpDetail;
        this.helpPaid = helpPaid;
        this.helpLike = helpLike;
